...
class DataAccess:
    ...
    Has methods to view marks, hobbies, travel, language
...
def main(ps_num, value):
    ...
    if ps_num < 99001200:
        print("Enter a ps number greater than or equal to 99001200")
        return 1
    elif ps_num > 99001214:
        print("Enter a ps number less than 99001215")
        return 2
...
def entry():
    ...
    try:
        ps1 = int(input("Enter a four digit PS_Number "
                        "ranging from 99001200-99001214:::"))
